...
AppPublisher=Arnion
AppPublisherURL=https://github.com/ArnionCode/arni-code
AppSupportURL=https://github.com/ArnionCode/arni-code/issues
AppUpdatesURL=https://github.com/ArnionCode/arni-code/releases
DefaultGroupName={#NameLong}
AllowNoIcons=yes
OutputDir={#OutputDir}
OutputBaseFilename=ArniCodeSetup
Compression=lzma
