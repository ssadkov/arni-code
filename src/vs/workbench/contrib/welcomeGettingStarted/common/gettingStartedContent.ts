...
export const startEntries: GettingStartedStartEntryContent = [
	...
	{
		id: 'topLevelOpenArni',
		title: localize('gettingStarted.topLevelOpenArni.title', "Open Arni..."),
		description: localize('gettingStarted.topLevelOpenArni.description', "Open Arni AI coding agent"),
		icon: Codicon.sparkle,
		content: {
			type: 'startEntry',
			command: 'command:arni.openAgent',
		}
	},
	{
		id: 'topLevelConfigureArni',
		title: localize('gettingStarted.topLevelConfigureArni.title', "Configure AI Provider..."),
		description: localize('gettingStarted.topLevelConfigureArni.description', "Configure Arni AI model provider and API settings"),
		icon: Codicon.settingsGear,
		content: {
			type: 'startEntry',
			command: 'command:arni.openSettings',
		}
	},
	{
		id: 'topLevelGitOpen',
